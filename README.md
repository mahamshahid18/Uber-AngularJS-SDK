...
```js
	app.controller("testController", function($scope, APIController,ProductCollection,PriceEsitmate,RequestBody,RequestDetailsCollections,Product,Request,UserProfile,Driver,TimeEstimate,Vehicle,UserActivity,Errors,History,PromotionsResponse,Location,RequestMapResponse,SurgeConfirmation,Meta,ErrorBase,TimeEstimateCollection,PriceEstimateCollection){
	});
```
...
```javascript
	...
	app.controller("testController", function($scope, APIController,ProductCollection,PriceEsitmate,RequestBody,RequestDetailsCollections,Product,Request,UserProfile,Driver,TimeEstimate,Vehicle,UserActivity,Errors,History,PromotionsResponse,Location,RequestMapResponse,SurgeConfirmation,Meta,ErrorBase,TimeEstimateCollection,PriceEstimateCollection){
	    var latitude = 169.062879005942;
    var longitude = 169.062879005942;
...
```javascript
	...
	app.controller("testController", function($scope, APIController,ProductCollection,PriceEsitmate,RequestBody,RequestDetailsCollections,Product,Request,UserProfile,Driver,TimeEstimate,Vehicle,UserActivity,Errors,History,PromotionsResponse,Location,RequestMapResponse,SurgeConfirmation,Meta,ErrorBase,TimeEstimateCollection,PriceEstimateCollection){
	    var startLatitude = 169.062879005942;
    var startLongitude = 169.062879005942;
...
```javascript
	...
	app.controller("testController", function($scope, APIController,ProductCollection,PriceEsitmate,RequestBody,RequestDetailsCollections,Product,Request,UserProfile,Driver,TimeEstimate,Vehicle,UserActivity,Errors,History,PromotionsResponse,Location,RequestMapResponse,SurgeConfirmation,Meta,ErrorBase,TimeEstimateCollection,PriceEstimateCollection){
	    var endLatitude = 169.062879005942;
    var endLongitude = 169.062879005942;
    var startLatitude = 169.062879005942;
    var startLongitude = 169.062879005942;
